...
const AUTHORITY = "../../contracts/schemas";
...
const issues: string[] = [];
if (source.length === 0) {
  throw new Error("Contracts authority must contain at least one schema");
}
// Extra files require an explicit reviewed removal, never a successful stale projection.
